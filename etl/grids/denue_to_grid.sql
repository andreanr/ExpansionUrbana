...
DROP TABLE IF EXISTS hex_grid_250.denue;

CREATE TABLE hex_grid_250.denue as (
	...
	FROM hex_grid_250.grid, denue_grouped
	GROUP BY cell_id
);

CREATE INDEX ON hex_grid_250.denue (cell_id);
